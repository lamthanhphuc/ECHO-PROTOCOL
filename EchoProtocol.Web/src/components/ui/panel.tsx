...
export function PageHeader({ eyebrow, title, description }: {
  ...
  return <header className="mb-6">
    ...
    <h1 className="page-title text-3xl font-semibold tracking-wide text-white md:text-4xl">{title}</h1>
...
export function StatCard({ label, value, detail }: { label: string; value: ReactNode; detail?: string }) {
  return <Panel>
    ...
    <p className="page-title mt-3 text-3xl font-semibold text-white">{value}</p>
