...
namespace EchoProtocol.EditorTools
{
    ...
    public static class GameplayHUDSceneSetup
    {
        ...
        static GameplayHUDSceneSetup()
        {
            EditorApplication.delayCall += CheckRunMarker;
        }
        ...
        private static Font GetDefaultFont()
        {
            ...
            _defaultFont = AssetDatabase.LoadAssetAtPath<Font>("Assets/Fonts/ECHO_HUD_Font.ttf");
            if (_defaultFont == null)
            {
                _defaultFont = AssetDatabase.LoadAssetAtPath<Font>("Assets/Photon/Fusion/Runtime/Statistics/Fonts/Roboto-Regular.ttf");
            }
            if (_defaultFont == null)
            {
        ...
        public static void SetupCompleteGameplayHUD()
        {
            ...
            // 1. Interaction Prompt (Center-Low)
        ...
        private static HUDInteractionPrompt CreateInteractionPrompt(Transform parent)
        {
            ...
            badgeRt.sizeDelta = new Vector2(46, 46);
            ...
            Text keyText = CreateText("KeyText", badgeGo.transform, "E", 22, FontStyle.Bold, Color.white);
            ...
            // Prompt Text
            Text promptText = CreateText("PromptLabel", promptGo.transform, "Tương tác", 20, FontStyle.Bold, Color.white);
            ...
            ptRt.anchoredPosition = new Vector2(76, 0);
            ptRt.sizeDelta = new Vector2(-160, 48);
            ...
            ringRt.sizeDelta = new Vector2(50, 50);
            ...
            // Percent Text
            Text percentText = CreateText("PercentText", ringContainer.transform, "0%", 15, FontStyle.Bold, Color.white);
        ...
        private static HUDObjectiveTracker CreateObjectiveTracker(Transform parent)
        {
            ...
            // Top Phase Badge
            Text phaseBadge = CreateText("PhaseBadge", objGo.transform, "GIAI ĐOẠN 1 // THU THẬP NĂNG LƯỢNG", 16, FontStyle.Bold, new Color(0f, 0.9f, 1f, 1f));
            ...
            pbRt.sizeDelta = new Vector2(-40, 24);
            phaseBadge.alignment = TextAnchor.MiddleCenter;

            // Objective Title
            Text objTitle = CreateText("ObjectiveTitle", objGo.transform, "TÌM VÀ NẠP ENERGY CORE", 22, FontStyle.Bold, Color.white);
            ...
            otRt.anchoredPosition = new Vector2(0, -38);
            otRt.sizeDelta = new Vector2(-40, 30);
            objTitle.alignment = TextAnchor.MiddleCenter;

            // Objective Detail (4 Cores as requested)
            Text objDetail = CreateText("ObjectiveDetail", objGo.transform, "Tìm và nạp 4 Energy Core về Sector Box [0/4]", 16, FontStyle.Bold, new Color(0.85f, 0.95f, 1f, 1f));
            ...
            odRt.anchoredPosition = new Vector2(0, -70);
            odRt.sizeDelta = new Vector2(-40, 24);
            ...
            barBgRt.sizeDelta = new Vector2(680, 10);
        ...
        private static HUDPlayerVitals CreatePlayerVitals(Transform parent)
        {
            ...
            rt.sizeDelta = new Vector2(450, 152);
            ...
            // Stamina Title
            Text stTitle = CreateText("StaminaTitle", vitalsGo.transform, "THỂ LỰC (STAMINA)", 16, FontStyle.Bold, new Color(0f, 0.9f, 1f, 1f));
            ...
            sttRt.sizeDelta = new Vector2(230, 24);
            stTitle.alignment = TextAnchor.MiddleLeft;

            // Stamina Value Text
            Text stVal = CreateText("StaminaValue", vitalsGo.transform, "100%", 18, FontStyle.Bold, Color.white);
            ...
            stvRt.sizeDelta = new Vector2(90, 24);
            ...
            stBgRt.sizeDelta = new Vector2(-48, 14);
            ...
            bRt.sizeDelta = new Vector2(170, 38);
            ...
            Text badgeText = CreateText("BadgeText", badgeBgGo.transform, "BÌNH THƯỜNG", 16, FontStyle.Bold, new Color(0f, 1f, 0.5f, 1f));
            ...
            // Bleedout Container (Bottom-Right of vitals, hidden by default)
            ...
            bcRt.anchoredPosition = new Vector2(206, 18);
            bcRt.sizeDelta = new Vector2(160, 38);

            Text bleedText = CreateText("BleedText", bleedContainer.transform, "HẤP HỐI: 45s", 15, FontStyle.Bold, new Color(1f, 0.3f, 0.3f, 1f));
            ...
            bleedContainer.SetActive(false); // CRITICAL: Deactivate by default!
            ...
            nRt.sizeDelta = new Vector2(0, 38);
            ...
            Text noiseLabel = CreateText("NoiseLabel", noiseGo.transform, "TIẾNG ĐỘNG // CHẠY NHANH", 15, FontStyle.Bold, new Color(1f, 0.8f, 0.2f, 1f));
            ...
            so.FindProperty("statusBadgeBg").objectReferenceValue = badgeBg;
            so.FindProperty("statusLabelText").objectReferenceValue = badgeText;
        ...
        private static HUDHotbar CreateHotbar(Transform parent)
        {
            ...
            rt.anchoredPosition = new Vector2(-40, 40);
            // Symmetrical width: 20px padding + 94px slot + 16px gap + 94px slot + 16px gap + 94px slot + 20px padding = 354px
            ...
            // Centered 3 Slots: -110, 0, +110
            // Slot 1
            GameObject s1Go = CreateSlotObject("Slot1", hotbarGo.transform, new Vector2(-110, 0), "1", out Image s1Icon, out Text s1Label, out GameObject s1Lock, out Text s1LockTxt);
            // Slot 2
            GameObject s2Go = CreateSlotObject("Slot2", hotbarGo.transform, new Vector2(0, 0), "2", out Image s2Icon, out Text s2Label, out GameObject s2Lock, out Text s2LockTxt);
            // Team Tool Slot (Key 3 or T)
            GameObject toolGo = CreateToolSlotObject("ToolSlot", hotbarGo.transform, new Vector2(110, 0), "3", out Image toolIcon, out Text toolLabel, out Image toolRadial, out Text toolCdText, out GameObject toolLock);
            ...
            out Image slotIcon, out Text slotLabel, out GameObject lockOverlay, out Text lockText)
        {
            ...
            rt.sizeDelta = new Vector2(94, 94);
            ...
            // Key tag
            Text key = CreateText("Key", slotGo.transform, keyNum, 16, FontStyle.Bold, new Color(0f, 0.9f, 1f, 1f));
            ...
            // Label
            slotLabel = CreateText("Label", slotGo.transform, "Trống", 14, FontStyle.Bold, Color.white);
            RectTransform lRt = slotLabel.GetComponent<RectTransform>();
            lRt.anchorMin = new Vector2(0f, 0f);
            lRt.anchorMax = new Vector2(1f, 0f);
            lRt.pivot = new Vector2(0.5f, 0f);
            lRt.anchoredPosition = new Vector2(0, 6);
            lRt.sizeDelta = new Vector2(-6, 22);
            ...
            lockText = CreateText("LockText", lockOverlay.transform, "VÁC CORE", 13, FontStyle.Bold, Color.white);
            ...
            out Image toolIcon, out Text toolLabel, out Image toolRadial, out Text toolCdText, out GameObject toolLock)
        {
            ...
            toolIcon.color = new Color(0f, 0.9f, 1f, 1f);
            toolIcon.gameObject.SetActive(false);

            // Cooldown Radial
            GameObject radGo = CreateUIObject("CooldownRadial", slotGo.transform);
            RectTransform radRt = radGo.GetComponent<RectTransform>();
            radRt.anchorMin = Vector2.zero;
            radRt.anchorMax = Vector2.one;
            radRt.sizeDelta = Vector2.zero;
            toolRadial = radGo.AddComponent<Image>();
            toolRadial.sprite = HUDTextureUtility.RoundedBox;
            ...
            toolRadial.color = new Color(0f, 0f, 0f, 0.7f);

            // Cooldown Number
            toolCdText = CreateText("CooldownText", radGo.transform, "", 18, FontStyle.Bold, new Color(0f, 0.9f, 1f, 1f));
            ...
            toolCdText.gameObject.SetActive(false);

            // Label
            toolLabel = CreateText("Label", slotGo.transform, "Tool", 14, FontStyle.Bold, new Color(0f, 0.9f, 1f, 1f));
        ...
        private static HUD3DWorldMarker Create3DWorldMarkers(Transform parent)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                mRt.sizeDelta = new Vector2(220, 70);
                ...
                // Title label
                Text title = CreateText("Title", mGo.transform, "CỨU ĐỒNG ĐỘI", 15, FontStyle.Bold, new Color(1f, 0.35f, 0.35f, 1f));
                ...
                // Distance label
                Text dist = CreateText("Distance", mGo.transform, "24m", 14, FontStyle.Bold, Color.white);
                ...
                dRt.sizeDelta = new Vector2(90, 20);
        ...
        private static Text CreateText(string name, Transform parent, string content, int fontSize, FontStyle style, Color color)
        {
            ...
            // Subtle single-pass shadow for contrast without geometry bleeding or blurring glyph counters
